...
const PatientConfigs = () => {
  return (
    <div className="p-4 space-y-2 flex flex-col">
      ...
      <RangeSlider min={0} max={100} label="Heart Rate" />
      <RangeSlider min={0} max={100} label="SP02" />
      <RangeSlider min={0} max={100} label="Systolic" />
      <RangeSlider min={0} max={100} label="Diastolic" />
      <div>
